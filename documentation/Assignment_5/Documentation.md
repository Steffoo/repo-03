...
1. Das Repository anlegen
   ...
   ![Create element](Pictures/create_element.png | width=100)
...
##### Deploy
In Stage "Deploy" ist es möglich die in "Build" erstellte .jar Datei zu starten. Somit hat man immer ein System der lauffähig und erreichbar ist.
```
stage('Deploy') {
               steps {
                   echo 'Deploying...'
